...
const projects = [
  {
    ...
    description:"A forum website built with NextJS, ExpressJS, MongoDB, and Serverless Functions.",
    details: [
      {
        title: "Forum Website",
        content: "This forum website is a fullstack appliaction built with the MERN Stack, and uses a serverless architecture with Netlify. Users can create an account with Netlify Identity, create posts and comment on them."
      },
  {
    name: "CRUD API",
    img: crudapi,
